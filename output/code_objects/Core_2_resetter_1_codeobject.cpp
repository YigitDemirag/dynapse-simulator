...
const size_t _numnot_refractory = 256;
    ...
    double*   _ptr_array_Core_2_Isoma_ahp_th = _array_Core_2_Isoma_ahp_th;
	...
	const int32_t _num_events = _ptr_array_Core_2__spikespace[256];

	//// MAIN CODE ////////////	
	// scalar code
	const size_t _vectorisation_idx = -1;
 	
 const double Isoma_ahp_th = _ptr_array_Core_2_Isoma_ahp_th[0];
