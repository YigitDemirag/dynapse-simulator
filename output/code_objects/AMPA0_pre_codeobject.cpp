...
const size_t _num_Iampa_g_post_AMPA0__Iampa_g_post_Core_1_subgroup_1__Iampa_g_Core_1_alpha = 1;
const size_t _num_Iampa_g_post_AMPA0__Iampa_g_post_Core_1_subgroup_1__Iampa_g_Core_1_Iampa_tau = 256;
...
const size_t _num_postsynaptic_idx = _dynamic_array_AMPA0__synaptic_post.size();
    ...
    const double _Iampa_g_post_AMPA0__Iampa_g_post_Core_1_subgroup_1__Iampa_g_Core_1_alpha = _ptr_array_Core_1_alpha[0];
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double _Iampa_g_post_AMPA0__Iampa_g_post_Core_1_subgroup_1__Iampa_g_Core_1_Iampa_tau = _ptr_array_Core_1_Iampa_tau[_postsynaptic_idx];
            const double weight = _ptr_array_AMPA0_weight[_idx];
            const double Iampa_g_post = _Iampa_g_post_AMPA0__Iampa_g_post_Core_1_subgroup_1__Iampa_g_Core_1_alpha * _Iampa_g_post_AMPA0__Iampa_g_post_Core_1_subgroup_1__Iampa_g_Core_1_Iampa_tau;
