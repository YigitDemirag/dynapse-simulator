...
void _run_NMDA0_pre_codeobject_1()
{
    ...
    ///// CONSTANTS ///////////
    const size_t _num_Inmda_g_post_NMDA0__Inmda_g_post_Core_0_subgroup_1__Inmda_g_Core_0_Inmda_tau = 256;
...
const size_t _num_Inmda_g_post_NMDA0__Inmda_g_post_Core_0_subgroup_1__Inmda_g_Core_0_alpha = 1;
...
const size_t _num_postsynaptic_idx = _dynamic_array_NMDA0__synaptic_post.size();
    ...
    double*   _ptr_array_Core_0_alpha = _array_Core_0_alpha;
    ...
    double* __restrict  _ptr_array_Core_0_Inmda_w0 = _array_Core_0_Inmda_w0;
    ...
    const double _Inmda_g_post_NMDA0__Inmda_g_post_Core_0_subgroup_1__Inmda_g_Core_0_alpha = _ptr_array_Core_0_alpha[0];
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double _Inmda_g_post_NMDA0__Inmda_g_post_Core_0_subgroup_1__Inmda_g_Core_0_Inmda_tau = _ptr_array_Core_0_Inmda_tau[_postsynaptic_idx];
            double Inmda_post = _ptr_array_Core_0_Inmda[_postsynaptic_idx];
            const double Inmda_w0 = _ptr_array_Core_0_Inmda_w0[_postsynaptic_idx];
            const double weight = _ptr_array_NMDA0_weight[_idx];
            const double Inmda_tau_post = _ptr_array_Core_0_Inmda_tau[_postsynaptic_idx];
            const double Inmda_g_post = _Inmda_g_post_NMDA0__Inmda_g_post_Core_0_subgroup_1__Inmda_g_Core_0_alpha * _Inmda_g_post_NMDA0__Inmda_g_post_Core_0_subgroup_1__Inmda_g_Core_0_Inmda_tau;
            Inmda_post += 1.0f*((Inmda_w0 * weight) * Inmda_g_post)/(Inmda_tau_post * (1.0 + (1.0f*Inmda_g_post/Inmda_post)));
            _ptr_array_Core_0_Inmda[_postsynaptic_idx] = Inmda_post;
